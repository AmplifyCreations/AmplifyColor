...
namespace AmplifyColor
{
	...
	{
		public static readonly string PrefStartUp = "ACLastSession" + Application.productName;
		public static readonly string PrefForceUpdate = "ACForceUpdate" + Application.productName;
	}

	public class StartScreen : EditorWindow
	{
		[MenuItem( "Window/Amplify Color/Start Screen", false, 19 )]
		public static void Init()
		{
			StartScreen window = (StartScreen)GetWindow( typeof( StartScreen ), true, "Amplify Color Start Screen" );
			window.minSize = new Vector2( 650, 500 );
			window.maxSize = new Vector2( 650, 500 );
			window.Show();
		}

		private static readonly string RefID = "Ref_Color";
		...
		private static readonly GUIContent TitleSTR = new GUIContent( "Amplify Color" );
